...
import com.example.languagecenter.LanguageCenter.LanguageCenterActivity;
import com.example.languagecenter.Student.HomeFragment;
import com.example.languagecenter.Student.StudentActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private int type;
    private String urlAccountStudent = "http://192.168.1.6/AppProject/FinalTerm/API/getAccountStudent.php/";
    private String urlAccountLangCenter = "http://192.168.1.6/AppProject/FinalTerm/API/getAccountLanguageCenter.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        si_SignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragmentTransaction.setCustomAnimations(android.R.anim.slide_in_left, android.R.anim.slide_out_right, android.R.anim.slide_in_left, android.R.anim.slide_out_right)
                        .add(R.id.si_layout, new SignUpFragment()).addToBackStack(MainActivity.ACTIVITY_SERVICE);
        ...
        si_ForgetPWD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                fragmentTransaction.setCustomAnimations(android.R.anim.slide_in_left, android.R.anim.slide_out_right, android.R.anim.slide_in_left, android.R.anim.slide_out_right)
                        .add(R.id.si_layout, new ForgetpwdFragment()).addToBackStack(MainActivity.ACTIVITY_SERVICE);
                fragmentTransaction.commit();
            }
        });
    }
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                if (response.length() > 0) {
                        ...
                        try {
                            ...
                            if (object.getString("Username").equals(si_username.getText().toString().trim())) {
                                if (object.getString("PWD").equals(si_pwd.getText().toString().trim())) {
                                    flag = false;
                                    if (type == 1) {
                                        Students students = new Students(object.getInt("StudentID"), object.getInt("OTP"), object.getString("Username"), object.getString("PWD"), object.getString("Gmail"));
                                        Intent intent = new Intent(MainActivity.this, StudentActivity.class);
                                        Bundle bundle = new Bundle();
                                        bundle.putSerializable(KEY_ACCOUNT, students);
                                        intent.putExtras(bundle);
                                        startActivity(intent);
                                    }
                                    if (type == 2) {
                                        Language_Center language_center = new Language_Center(object.getInt("LangID"), object.getInt("OTP"), object.getString("Username"), object.getString("PWD"), object.getString("Gmail"));
                                        Intent intent = new Intent(MainActivity.this, LanguageCenterActivity.class);
                                        Bundle bundle = new Bundle();
                                        bundle.putSerializable(KEY_ACCOUNT, language_center);
                                        intent.putExtras(bundle);
                                        startActivity(intent);
                                    }
                                }
                    ...
                    if(flag)
                        Toast.makeText(MainActivity.this, "Tên tài khoản hoặc mật khẩu không chính xác!", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(MainActivity.this, "Tên tài khoản hoặc mật khẩu không chính xác!", Toast.LENGTH_SHORT).show();
                }
            }
